package com.zc.spring_security_demo.myconfig;
   ...
   //         return new BCryptPasswordEncoder();// 密码加密
        ...
        /*auth.inMemoryAuthentication()
            ...
            auth.inMemoryAuthentication()
                    ...
                    .withUser("user").password("$2a$10$3TQ2HO/Xz1bVHw5nlfYTBON2TDJsQ0FMDwAS81uh7D.i9ax5DR46q").roles("user")
                     .and()
                    .withUser("other").password("qqqqqqq").roles();
            ;// 密码加密
        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            http.authorizeRequests()
                    ...
                    // 定义登录时，用户名的 key，默认为 username,表单提交用户名的key
                    .usernameParameter("uname")
                    // 定义登录时，密码的 key，默认为 password,表单提交密码的key
